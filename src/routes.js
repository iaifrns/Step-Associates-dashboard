  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        element: lazy(() => import('./views/estimate/estimates/index'))
      },
      {
        exact: 'true',
        path: '/estimate/detail',
        element: lazy(() => import('./views/estimate/estimateDetail'))
      },
      {
        exact: 'true',
        path: '/estimate/costing',
        element: lazy(() => import('./views/estimate/estimateCost'))
      },
      {
        exact: 'true',
        path: '/estimate/create',
        element: lazy(() => import('./views/estimate/estimates/createEstimate/index'))
      },
      {
        exact: 'true',
        path: '/estimate/templates',
        element: lazy(() => import('./views/template/index'))
      },
      {
        exact: 'true',
        path: '/rates/price-list',
        element: lazy(() => import('./views/library/index'))
      },
      {
        exact: 'true',
